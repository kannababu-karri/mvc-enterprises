...
<title>MVC-Microservices Application: User</title>
</head>
<body>
<jsp:include page="/WEB-INF/pages/common/header.jsp" flush="true" />

<form:form action="/user/updateUser" method="post" modelAttribute="userForm.user" id="userForm">
	<p class="searchTitle">&nbsp;&nbsp;User Interface: Update User</p>
		<p class="searchTitle">
	...
	<table width="100%">			
		<tr>
			...
			<td width="30%" align="left"><input type="password" name="password" value="${userForm.user.password}" /></td>
			<td width="49%">&nbsp;</td>
		</tr>
		<tr>
			<td width="1%">&nbsp;</td>			
		...
		<tr>
			...
			<td width="50%" align="center" colspan="2">
				<input type="submit" value="Update" />&nbsp;&nbsp;<input type="button" value="Cancel" onclick="javascript:jsUserSubmit('/user/showUserDetails');" />
			</td>
			<td width="49%">&nbsp;</td>
		</tr>				
	</table>
