...
<form:form action="${pageContext.request.contextPath}/aiAgent/showAiAgentResult" method="post" id="aiAgentForm" enctype="multipart/form-data">
	...
	<c:if test="${not empty aiResult}">
		<p class="searchTitle">&nbsp;&nbsp;AI GMP Audit Report:</p>
	    &nbsp;&nbsp;
