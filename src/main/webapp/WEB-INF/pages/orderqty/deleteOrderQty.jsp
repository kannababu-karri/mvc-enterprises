...
<form:form action="${pageContext.request.contextPath}/orderqty/deleteOrderQty" method="post" modelAttribute="orderQtyForm.orderQty" id="orderQtyForm">
	<p class="searchTitle">&nbsp;&nbsp;Order Interface: Order Delete</p>
		<p class="searchTitle">
	...
	<table width="100%">			
		...
		<tr>
			...
			<td width="30%" align="left">${orderQtyForm.orderQty.quantity}</td>
			<td width="49%">&nbsp;</td>
		</tr>
		<tr>
			<td width="100%" colspan="4">&nbsp;</td>
