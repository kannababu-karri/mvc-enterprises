...
<form:form action="${pageContext.request.contextPath}/product/updateProduct" method="post" modelAttribute="productForm.product" id="productForm">
	<p class="searchTitle">&nbsp;&nbsp;Product Interface: Update Product</p>
		<p class="searchTitle">
	...
	<table width="100%">			
		...
		<tr>
			...
			<td width="50%" align="center" colspan="2">
				<input type="submit" value="Submit" />&nbsp;&nbsp;<input type="button" value="Cancel" onclick="javascript:jsProductSubmit('${pageContext.request.contextPath}/product/showProductDetails');" />
			</td>
			<td width="49%">&nbsp;</td>
		</tr>					
	</table>
