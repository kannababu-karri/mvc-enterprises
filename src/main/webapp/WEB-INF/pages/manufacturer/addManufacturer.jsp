...
<form:form action="${pageContext.request.contextPath}/manufacturer/saveNewManufacturer" method="post" modelAttribute="manufacturerForm.manufacturer" id="manufacturerForm">
	<p class="searchTitle">&nbsp;&nbsp;Manufacturer Interface: Add New Manufacturer</p>
		<p class="searchTitle">
